...
export default function Header() {
  ...
  return (
    <div className="grid grid-cols-2  lg:px-0 md:grid-cols-3 lg:grid-cols-3 items-center text-center fixed w-full top-0 md:flex md:justify-around bg-white md:border-b-5 md:border-white z-100 lg:h-25 ">
