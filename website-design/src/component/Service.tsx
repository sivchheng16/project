function Service() {
  return (
    <div className="bg-gray-100 py-15 px-3 grid grid-cols-1 gap-8">
      <div className="text-center">
        <h1 className="font-bold text-2xl pb-5">Out Service</h1>
      ...
      {/* card */}
      {/* 1 */}
      <div className="py-15 px-10 bg-white  border border-gray-300 shadow-2xl rounded-2xl">
      ...
      <div className="py-15 px-10 bg-white  border border-gray-300 shadow-2xl rounded-2xl">
        ...
        <p className=" text-gray-600 text-sm pb-5">
          Butiful, user-friendly designs that convert visites tnto customers and
          provide exceptional user exerpriences.
        </p>
      ...
      <div className="py-15 px-10 bg-white  border border-gray-300 shadow-2xl rounded-2xl">
        ...
        <p className=" text-gray-600 text-sm pb-5">
          Nativeand hybird mobile applications for iOS and android platform with
          seamles user experiences.
        </p>
