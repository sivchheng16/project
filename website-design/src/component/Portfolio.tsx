    ...
    <div className="grid grid-cols-1 gap-10 bg-gray-50 pb-15">
      ...
      <div className="md:grid md:grid-cols-2 md:gap-5">
        <div className="mx-3 rounded-2xl shadow-2xl block hover:-translate-y-1 hover:duration-400 hover:shadow-2xl hover:shadow-gray-500">
          ...
          <div className="p-5">
            <h1 className="font-bold py-3 md:text-2xl md:font-normal">TechCorp Enterprise</h1>
        ...
        <div className="mx-3 rounded-2xl shadow-2xl block hover:-translate-y-1 hover:duration-400 hover:shadow-2xl hover:shadow-gray-500">
          ...
          <div className="p-5">
            <h1 className="font-bold py-3 md:text-2xl md:font-normal">Fashion Hub Marketplace</h1>
            <p className="text-gray-500 text-sm ">
