function Portfolio() {
  return (
    <div className="grid grid-cols-1 gap-10 bg-gray-50 pb-15">
      <div className="pt-10 text-center">
        <h1 className="font-bold text-2xl p-5">Our Portfolio</h1>
        <p className=" text-gray-500">
          Explore some of our recent projects and success story
        </p>
      </div>
      {/* card */}
      <div className="mx-3 rounded-2xl shadow-2xl block">
        <div className="bg-gradient-to-br from-indigo-500 to-violet-500 rounded-tl-2xl rounded-tr-2xl py-10 text-center">
          <span className=" text-6xl">🏛️</span>
          <p className="pt-5 text-white font-bold text-sm">
            Corporate Platform
          </p>
        </div>
        <div className="p-5">
          <h1 className="font-bold py-3">TechCorp Enterprise</h1>
      ...
      <div className="mx-3 rounded-2xl shadow-2xl block">
        ...
        <div className="p-5">
          <h1 className="font-bold py-3">Fashion Hub Marketplace</h1>
          <p className="text-gray-500 text-sm">
